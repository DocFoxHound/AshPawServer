  ...
  if (1)
    set_target_properties(tomlplusplus::tomlplusplus PROPERTIES
       IMPORTED_CONFIGURATIONS "DEBUG;RELEASE"
          IMPORTED_LOCATION_DEBUG "${PACKAGE_PREFIX_DIR}/debug/lib/libtomlplusplus.a"
          IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/libtomlplusplus.a"
    )
    # compile_options not quoted on purpose
    target_compile_options(tomlplusplus::tomlplusplus INTERFACE -DTOML_HEADER_ONLY=0)
  endif()
